...
#ifndef CONJUNCTIVEQ_ARGUMENT_HELPER_H
#define CONJUNCTIVEQ_ARGUMENT_HELPER_H
...
namespace dsr{
    ...
    public:
        ...
        void new_optional_int(const char *value_name,
                              ...
                              int &dest);
        void
        new_named_bool(char key, const char *long_name, const char *arg_description, const char *description, bool &dest);
        void new_bool(const char *arg_description, const char *description, bool &dest);
        ...
        void new_named_unsigned_vector(char key, const char *long_name, const char *arg_description, const char *description,
                                       std::vector<unsigned int> &dest);
        void new_unsigned_vector(const char *arg_description, const char *description, std::vector<unsigned int> &dest);
...
#define ARGUMENT_HELPER_BASICS(ah) ah.set_author("Daniel Russel, drussel@stanford.edu");\
 ah.set_version("unknown");\
 ah.set_build_date(__DATE__);

#endif

#endif //CONJUNCTIVEQ_ARGUMENT_HELPER_H